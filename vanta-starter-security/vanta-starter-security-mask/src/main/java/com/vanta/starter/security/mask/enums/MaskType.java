package com.vanta.starter.security.mask.enums;
...
public enum MaskType implements IMaskStrategy {
    ...
    CUSTOM {
         ...
         * @param character character 参数，调用方应传入与 安全防护能力 场景匹配的有效值
         * @param left left 参数，调用方应传入与 安全防护能力 场景匹配的有效值
         * @param right right 参数，调用方应传入与 安全防护能力 场景匹配的有效值
