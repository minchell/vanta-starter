 ...
 * 业务规则校验工具类。
 * <p>
 * 该类面向“请求格式合法，但业务状态不允许继续”的场景，所有校验失败都会抛出 {@link BusinessException}。
 * 它继承 {@link Validator} 的基础判断能力，并增加实体存在性检查和消息模板格式化能力。
 * </p>
 */
